                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <%  HttpSession miSession = request.getSession();
                                            ...
                                            listaClientes = (List) request.getSession().getAttribute("listaClientes");
                                        ...
                                        <tr>
                                            ...
                                            <td><%=estado%></td>
                                            <td>
                                                <form action="SvEditarCliente" method="POST" style="display: inline">
                                                    <input type="hidden" name="id" value="<%=id%>">
                                                    <button type="submit" style="display: inline">Editar</button>
                                                </form>                                                
                                            </td>
                                            <td>
                                                <form action="SvEliminarCliente" method="POST" style="display: inline">
                                                    <input type="hidden" name="id" value="<%=id%>">
